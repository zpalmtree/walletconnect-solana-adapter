import { WalletConnectChainID, WalletConnectWallet, } from './core.js';
...
export class WalletConnectWalletAdapter extends BaseSignerWalletAdapter {
    ...
    _wallet;
    _config;
    _readyState = typeof window === 'undefined' ? WalletReadyState.Unsupported : WalletReadyState.Loadable;
    _onDisconnect;
    constructor(config) {
        super();
